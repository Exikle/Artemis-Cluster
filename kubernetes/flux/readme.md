...
````
kubectl apply --server-side --kustomize ~/Artemis-Cluster/kubernetes/bootstrap
...
- sops --decrypt ~/Artemis-Cluster/kubernetes/bootstrap/github.secret.sops.yaml | kubectl apply --server-side --filename -
