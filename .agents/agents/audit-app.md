...
| `postgres/cert` | **The app's driver can present a PEM client cert.** `pg_hba` is `cert clientcert=verify-full`; there is no password (`postgres-dragonfly.md`).                                                                                                                                                                                                                                                                                  | Step 2.                                                                                                                                                                                                                                                                                                                                                                                                                                |
